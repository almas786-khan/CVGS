...
namespace CVGS.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        public ActionResult AddGame([Bind(Include =" GameName, GameDescription,GamePrice, GameOverallRating, ImageURL, ImageFile")]Game model, HttpPostedFileBase ImageFile)
        {
            try
            {
                if (ImageFile == null)
