...
namespace CVGS.Controllers
{
    public class FriendController : Controller
    {
            ...
            using (cvgsEntities2 db = new cvgsEntities2())
            {
                ...
                foreach (var item in db.Friends)
                {
                    ...
                    if (item.Member1ID == userId && item.IsApprove==false)
                    {
                        ...
                        //{
                        //    //for friend button
                        //    arrFriendListForApprove.Add(item.FriendId + "a" + 1);
                        //}
                        //else if (item.IsApprove == 2)
                        //{
                        //    //for decline 
                        //    arrFriendListForApprove.Add(item.FriendId + "a" + 2);
                        //}
        ...
        //    using (cvgsEntities1 db = new cvgsEntities1())
        //    {
        //        var userId = db.Users.FirstOrDefault(x => x.UserName == System.Web.HttpContext.Current.User.Identity.Name).UserID;
        ...
        //            if (item.Member1ID == userId && item.IsApprove == true)
        //            {
        //                if (item.Member2ID != null)
        //                {

        //                    arrList.Add(item.Member2ID);
        ...
        //    TempData["CheckFriendId"] = arrList.ToArray(typeof(object));
        //}
        [HttpGet]
        ...
        //                return View(_context.Users.Where(x => (x.UserName != name && x.UserType == "Member")).ToList());
        //            }
        //            else if (!findFriend1 && !findFriend)
        //            {
        ...
        //                TempData["friendAdded"] = "Friend request sent successfully.";
        //                ViewBag.friendAdded = TempData["friendAdded"];
        //                return View(_context.Users.Where(x => (x.UserName != name && x.UserType == "Member" && x.UserID!=FriendID)).ToList());
        //            }
